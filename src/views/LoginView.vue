   ...
   <div class="flex items-center h-screen w-full bg-page-pattern bg-no-repeat bg-cover">
        <div class="w-full max-w-xs m-auto bg-hero-pattern rounded p-8">  
            <div class="p-8 bg-primary rounded-lg">
                <h1 class="text-xl py-3 text-secondary font-bold">Login to Account</h1>
                ...
                <p><button @click="login" class="text-secondary font-medium rounded-lg px-4 py-2 bg-button hover:bg-button-hover duration-300 w-full">Submit</button></p>
            </div>
        </div>
    </div>
</template>
